...
namespace Components.Player.Upgrades
{
    ...
    public class ExtraHammerCrossUpgrade : HitUpgrade
    {
        ...
        public ExtraHammerCrossUpgrade(IHitResolver inner, GridContext gridContext, int level, float extraHammerDamagePerLevel, float extraHammerDamageBase) : base(inner, gridContext, level)
        {
